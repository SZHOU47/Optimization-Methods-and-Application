...
# maximum allowed travelling distance that any team travels
for i in range(24):
     m1.addConstr(sum(2*x[j,i,k]*E.iloc[j,i] for j in range(24) for k in range(13) if (j != i)&(k != 8))<=11000,f"c6{i}")
